...
arrays and mappings. If you specify a reference type, you always have to explicitly
...
An assignment that changes the data location will always incur an automatic copy operation,
while assignments inside the same data location only copy for storage types.
